...
exports.getUser = catchAsync(async (req, res) => {
    // check if user is requesting his own posts or someone else's
    const username = req.param.username || req.user.username;
...
//Update user details (intensive(not user password))
exports.updateMe = catchAsync(async (req, res) => {
    if (req.body.password) {
        throw new AppError(
            "This route is not updating password. Please use /updatePassword instead",
            400
        )
    }
...
//Search for user using name and username
...
//Search for user using name/ username
...
//Setup multer for image and file handling
